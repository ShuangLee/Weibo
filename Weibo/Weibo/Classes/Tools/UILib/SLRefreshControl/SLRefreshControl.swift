...
/// 刷新状态切换的临界点
private let SLRefreshOffset: CGFloat = 126
...
class SLRefreshControl: UIControl {
    ...
    /// 刷新视图
    fileprivate lazy var refreshView: SLRefreshView = SLRefreshView.refreshView()
    ...
    */
    ...
    override func observeValue(forKeyPath keyPath: String?, of object: Any?, change: [NSKeyValueChangeKey : Any]?, context: UnsafeMutableRawPointer?) {
        ...
        if sv.isDragging {
            ...
            if height > SLRefreshOffset && (refreshView.refreshState == .normal) {
                print("放手刷新")
                refreshView.refreshState = .pulling
            } else if height <= SLRefreshOffset && (refreshView.refreshState == .pulling) {
                print("继续使劲...")
    ...
    func beginRefreshing() {
        ...
        inset.top += SLRefreshOffset
        
        sv.contentInset = inset
        
        // 设置刷新视图的父视图高度
        refreshView.parentViewHeight = SLRefreshOffset
