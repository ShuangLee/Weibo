...
class HttpClientManager: AFHTTPSessionManager {
    private static let instance: HttpClientManager = {
        let instance = HttpClientManager()
        // 设置响应反序列化支持的数据类型
    ...
    class var shared: HttpClientManager {
        return instance
    }
    ...
    func tokenRequest(method: HTTPMethod = .get, URLString: String, parameters: [String: AnyObject]?, name: String? = nil, data: Data? = nil, completion: @escaping (_ json: Any?, _ isSuccess: Bool)->()) {
