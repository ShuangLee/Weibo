...
class WBVistorView: UIView {
    ...
    /// 注册按钮
    lazy var registerButton: UIButton = UIButton.sl_titleButton(title: "注册", fontSize: 16, color: UIColor.orange, highlightColor: UIColor.black, backgroundImageName: "common_button_white_disable")
    /// 登录按钮
    lazy var loginButton: UIButton = UIButton.sl_titleButton(title: "登录", fontSize: 16, color: UIColor.darkGray, highlightColor: UIColor.black, backgroundImageName: "common_button_white_disable")
    ...
    /// 提示标签
    lazy var tipLabel: UILabel = UILabel.sl_label(text: "关注一些人，回这里看看有什么惊喜关注一些人，回这里看看有什么惊喜", fontSize: 14, color: UIColor.darkGray)
}
...
extension WBVistorView {
    ...
    func setupUI() {
        backgroundColor = UIColor.rgbaColor(r: 232, g: 232, b: 232)
